...
#blastn -query wt_ref_corrected_by_reads.fa -db Sg2dbBLAST -out outputSg2_blast_max_num0.txt -evalue 10 -outfmt 6 -num\_descriptions 100000 -num\_alignments 100000
#blastn -query wt_ref_corrected_by_reads.fa -db Sg2dbBLAST -out outputSg2_blast_max_num2.txt -evalue 1 -num\_descriptions 100000 -num\_alignments 100000
blastn -query wt_ref_corrected_by_reads.fa -db WtdbBLAST -out outputWt_blast_max_num2.txt -evalue 1 -num\_descriptions 100000 -num\_alignments 100000
